...
const StepperMap = () => {
  ...
  const [orderPlace, setOrderPlace] = useState({ status: 'incomplete', time: '' });
  ...
  }, [orderPlace.status, sanitized.status, inTransit.status, riderReached.status]);
    ...
    <div className="order-status">
      ...
      <div className="step">
        <div className="step-header">
          ...
          ></span>
          <img src={down} width={'15px'} style={{ marginLeft: '8px' }} alt="down arrow" />
          <div className='step-time-container'> <span>{orderPlace.time}</span></div>
        </div>
      </div>
      ...
      <div className="step">
        <div className="step-header">
          ...
          ></span>
          <img src={down} width={'15px'} style={{ marginLeft: '8px' }} alt="down arrow" />
          <div className='step-time-container'> <span>{sanitized.time}</span></div>
        </div>
      </div>
      ...
      <div className="step">
        <div className="step-header">
          ...
          ></span>
          <img src={scooterIcon} width={'15px'} style={{ marginLeft: '8px' }} alt="scooter icon" />
          <div className='step-time-container'> <span>{inTransit.time}</span></div>
        </div>
      </div>
      ...
      <div className="step">
        <div className="step-header">
          <div className="step-title-container">
            {riderReached.status == 'Done' ? (<span className="step-title">Dilvered</span>) : (<span className="step-title">Rider reached</span>)}
          </div>
          <span
            className="step-dot"
          ...
          ></span>
          <img src={scooterIcon} width={'15px'} style={{ marginLeft: '8px' }} alt="scooter icon" />
         <div className='step-time-container'> <span>{riderReached.time}</span></div>
        </div>
      </div>
