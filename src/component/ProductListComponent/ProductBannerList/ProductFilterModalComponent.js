...
import {
  ...
  filterByVeg,
  resetFilters,
} from "../../../redux/Slices/Product/productSlice"; // Import Redux actions
import { Images } from "../../../assets";

const ProductFilterModalComponent = ({ closeModal }) => {
  const [activeTab, setActiveTab] = useState("v-pills-home"); // State to manage active tab
  const [productRating, setProductRating] = useState(3);
  ...
  const PRODUCT_TYPES = [
    { id: 1, label: "Brought By You", value: "brought" },
    { id: 2, label: "Veg", value: true },
    { id: 3, label: "Non Veg", value: false },
    { id: 4, label: "New Arrivals", value: "new" },
    { id: 5, label: "Vegans", value: "vegan" },
    { id: 6, label: "Eggitarian", value: "eggitarian" },
  ];
  ...
  const applyFilters = () => {
    // Dispatch Redux actions for filtering
    dispatch(filterByRating(productRating));
    // Add any other dispatches based on selected filters
  ...
  const resetAllFilters = () => {
    ...
    closeModal(); // Close the modal after resetting filters
  };
  ...
  return (
    <>
      ...
      <div className="offcanvas-body">
        <div className="mt-2">
          <div className="d-flex flex-wrap justify-content-between gap-1 border-bottom">
            {PRODUCT_TYPES.map((value) => {
              let checkboxClass = "form-check-input";
              if (value.label === "Veg") checkboxClass += " red-checkbox";
              else if (value.label === "Eggitarian")
                checkboxClass += " yellow-checkbox";
        ...
        <div className="mt-3 row border-bottom">
          <div className="d-flex align-items-start">
            ...
            <div className="col-8">
              <div className="tab-content p-4 pe-4" id="v-pills-tabContent">
                {BrandProducts.map((tab) => (
                  <div
                    key={tab.id}
                    className={`tab-pane fade ${
      ...
      <div className="row m-0">
        <div
          className="col bg-warning showcartsummar-bottom-button-container"
