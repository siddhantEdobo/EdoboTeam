...
//               <div className=" p-4 offer-web-coupon-code-container shadow-sm ">
//                 <span className="fs-6">Use Couponcode:</span>
//                 <span className="fs-1">HOWDY10</span>
//                 <div className="fs-6">And get Discount on First Order</div>
//               </div>
//             </div>
//             <img src={backgroundbanner} alt="r" className="h-25 w-100" />
//           </div>
//         </div>
//         <div className="position-relative align-items-center justify-content-center d-flex offer-coupon-code-subcontainer ">
//           <div className="p-4 offer-web-coupon-code-container shadow-sm ">
//             <div className="row">
//               <div className="col offer-web-coupon-img-container m-1 ">
//                 <img
//                   src={
